...
export function BotonesEstadoReserva({ id, estadoActual }: { id: number, estadoActual: string }) {
  
  if (estadoActual === "cancelada") {
    return <span className="text-xs text-gray-400 ml-4 shrink-0">Cancelada</span>;
  }
