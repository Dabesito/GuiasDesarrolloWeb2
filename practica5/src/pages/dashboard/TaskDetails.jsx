    ...
    return (
        <div className="max-w-4xl mx-auto p-6">
            ...
            <div className="card">
                <div className="flex justify-between items-start mb-6">
                    <div className="flex-1">
                        ...
                        <div className="flex flex-wrap gap-2 mb-4">
                            ...
                            {task.dueDate && (
                                <span className={`px-3 py-1 rounded-full text-sm font-medium ${isoverdue(task.dueDate, task.completed) ? 'bg-red-100 text-red-800' : 'bg-blue-100 text-blue-800'}`}>
                ...
                <div className="border-t pt-6 mt-6">
                    <button onClick={handleToggleComplete} className={task.completed ? 'btn-secondary w-full' : 'btn-primary w-full'}>
